...
exports.create = (req,res)=>{
    ...
    const incidencia = new Incidencia({
        ...
        tipoAmonA: req.body.tipoAmonA || "Sin Nombre",
        tipoAmonB: req.body.tipoAmonB || "Sin Nombre",
        tipoAmonC: req.body.tipoAmonC || "Sin Nombre",
        tipoAmonD: req.body.tipoAmonD || "Sin Nombre",
        tipoAmonE: req.body.tipoAmonE || "Sin Nombre",
        dies: req.body.dies || "Sin dies",
        tipoAmonG: req.body.tipoAmonG || "Sin Nombre",
        ...
        tipoAmonH: req.body.tipoAmonH || "Sin Nombre",
        suspensio: req.body.suspensio || "Sin suspensio",
        tipoAmonI: req.body.tipoAmonI || "Sin Nombre",
